...
<div id="templatemo_main">
  ...
  <div id="box">
    <table width="100%" height="746" border="0" align="right">
      <tr>
        <td height="24" colspan="2"><img src="slide/slide01.jpg" width="960" height="300" alt="home" /></td>
        </tr>
      <tr>
      ...
      <tr>
        <td>
          <table width="100%" border="0">
            <tr>
              <td width="98%" rowspan="2"><marquee><p><a href="">Welcome to STTC, Moulali Official Website</a></p></marquee>
          <p>&nbsp;</p>
