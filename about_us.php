  ...
  <div class="cleaner">
    <div id="templatemo_menu" class="ddsmoothmenu">
      <ul>
        ...
        <li><a href="about_us.php" class="selected">About Us</a></li>
...
<div id="templatemo_main">
  ...
  <table width="100%" border="0">
    <tr>
      <td colspan="3"><P>About Signal &amp; Telecommunication Training Center, Moula-ali.</P>
<P>&nbsp;</P>
      <P>&nbsp;</P></td>
      <td width="24%">&nbsp;</td>
    </tr>
    <tr>
      <td width="25%">Introduction Of STTC :</td>
      <td width="25%">&nbsp;</td>
      <td width="26%">&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
